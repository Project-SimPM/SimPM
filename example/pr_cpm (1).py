...
def prcpm(list_priority):
    def a0(e,r):
        ...
        yield e.put(r,1)
        e.finish_time=env.now



    def a1(e,r):
        yield p0
        if en[0].finish_time==env.now:
            en[0].critical=True
        else:
            en[0].critical=False
    ...
    def a3(e,r):
        yield p1&p2
        if en[1].finish_time==env.now:
            en[1].critical=True
        else:
            en[1].critical=False
        if en[2].finish_time==env.now:
            en[2].critical=True
        else:
            en[2].critical=False
    ...
    def a6(e,r):
        yield p4&p5&p3
        if en[3].finish_time==env.now:
            en[3].critical=True
        else:
            en[3].critical=False
        if en[4].finish_time==env.now:
            en[4].critical=True
        else:
            en[4].critical=False
        if en[5].finish_time==env.now:
            en[5].critical=True
        else:
            en[5].critical=False
